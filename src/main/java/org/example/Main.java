...
public class Main {
    public static void main(String[] args) {
        System.out.println("This is the base code");
        System.out.println("This is the code change for the new created branch");
        ...
        //These are the code changes for branch 8
        System.out.println("This is the code changes for the branch 8");
